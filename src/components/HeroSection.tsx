          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg lg:text-xl text-white/70 leading-relaxed max-w-2xl font-light">
                Перед началом любого проекта особое внимание уделяем смыслам — 
                устраняем хаос в массиве информации и создаем понятный для вашей целевой аудитории digital продукт
              </p>
            </div>
